...
├─────────────────────────────────────────────────────────────────┤
│  Local telemetry extensions  (optional)                         │
│  • extra allocator signals merged into InferenceTelemetry       │
└─────────────────────────────────────────────────────────────────┘
```
...
These fields are merged into the `InferenceTelemetry` snapshot emitted on
every telemetry interval for local analysis and debugging.
